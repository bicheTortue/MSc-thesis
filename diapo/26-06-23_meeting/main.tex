...
\begin{frame}{Networking and sharing}
  \begin{tikzpicture}
    \leftRect{Help/Collaboration :}{- If anybody has any idea of an interesting LSTM/NN problem to work on.\\-Also if any phenomen happening are familiar to you, I'll take the help\\- I would need the feature size of a typical memristor}
