...
{%
  ...
  \logo{\includegraphics[height=0.7cm]{logos/inesc-mn}\hspace{0.5cm}\includegraphics[height=0.7cm]{logos/ist}\hspace{0.5cm}\includegraphics[height=0.7cm]{logos/inesc-id}}
