...
For the thesis, this step is done in python and integrated in the netlist generator script (\cref{sec:netlist}). Since the resistance resolution is of about%TODO check memristor precision
