...
Where $V_{out}$ is the output voltage the inverting amplifier (\cref{apsec:sumInv}), $V_{voltMult}$ is the out voltage of the voltage multiplier itself and $V_{in_1}$ and $V_{in_2}$ are the input voltages.
