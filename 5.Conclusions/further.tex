...
This can be could be solved by adding a single capacitor before the input pin of the memory cell and then enabling the input of the memory cell at the very end of the serial time step.
Adding a capacitor after the output pin to store the value after the output enable flag goes to low.

This is not a working solution, simply a theory on how to optimize onChip area.
