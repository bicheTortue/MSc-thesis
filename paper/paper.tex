...
RNNs are a family of neural networks that differentiate themselves by having feedback connections. It alloww it to be used with sequences of data, sometimes, with varying amount of input data.
