...
The best looking output of the four predicted neurons responses is the one from PVR. That is confirmed by its \ac{RMSE} with the digital prediction. It is the lowest of the four, however, it isn't close enough to the digital prediction.
